                ...
                <div className="flex flex-wrap">
                    ...
                    >
                        ...
                        <div className="flex gap-2">
                            <a href="#contact"
                                className={'text-[12px] font-semibold text-white dark:text-[#1A1A1A] py-3 px-8 bg-dark dark:bg-[#CCCCCC] hover:opacity-75 rounded-full transition duration-300 ease-in-out'}>Hubungi
                                Saya</a>
                            <button onClick={openModal}
                                className={'text-[12px] font-semibold text-dark py-3 px-8 border dark:text-white border-dark dark:border-white rounded-full lg:hidden'}>
                                Resume
                            </button>
                        </div>
