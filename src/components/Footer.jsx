            ...
            <div className="container">
                <div className="flex flex-wrap">
                    <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                        <h2 className={'font-bold text-white text-3xl mb-5'}>farhnDev</h2>
                        <h3 className={'font-bold text-2xl mb-2'}>Web Developer Junior</h3>
                        <p>Jl.Gebang Mampang,Ds.Margamulya,Kec.Bongas</p>
                        <p>Indramayu</p>
                    </div>
                ...
                <div className="w-full pt-10 border-t border-slate-700">
                    ...
                    <p className={'font-medium text-secondary text-xs text-center '}><a href="#" target={'_blank'}
                                                                                        className={'text-primary'}>Farhan
